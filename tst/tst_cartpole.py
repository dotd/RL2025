...
def train_agent(
    ...
    agent = DQNAgent(
        state_size, action_size, hidden_size, ender_frequency, gamma, epsilon, epsilon_min, epsilon_decay, learning_rate, batch_size, buffer_size
    )
    ...
    logging.info("Training DQN Agent on CartPole-v1")
